...
This file is the published compatibility contract for **BDVM.Full 2.1.0**. It describes the current incremental release; it is not a promise that BDVM is feature-complete.
