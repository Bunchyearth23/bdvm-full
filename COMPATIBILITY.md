...
| External runtime dependencies | Multiplayer, SelfShunt, PassengerJobs, PassengerJobs.API, RemoteDispatchLive; DVLangHelper transitively | A missing optional runtime disables only the dependent bridge or feature. |
